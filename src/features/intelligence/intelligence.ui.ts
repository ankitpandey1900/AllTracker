    ...
    <div class="maamu-chat-area">
      ...
      <div class="maamu-input-zone">
        ...
        <div class="maamu-template-row">
          <button class="maamu-template-btn" data-template-id="my-progress-summary" data-template-category="web" data-template="Look at my full AllTracker data: rank, total hours, 30-day daily history, momentum score, routine completion, and task debt. Give me a concise professional summary of where I stand right now and what to improve next."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Progress Summary</span></button>
          <button class="maamu-template-btn" data-template-id="my-rank-breakdown" data-template-category="web" data-template="Using my leaderboard rank and total hours, estimate how many hours I should complete this week to move up one rank tier. Compare me with the top users and provide a practical plan."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Rank Breakdown</span></button>
          ...
          <button class="maamu-template-btn" data-template-id="interview-me" data-template-category="general" data-template="Take my interview now. Ask one challenging question at a time and provide clear, professional feedback before moving to the next question."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Interview Me</span></button>
