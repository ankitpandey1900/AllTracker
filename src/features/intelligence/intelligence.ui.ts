    ...
    <div class="maamu-chat-area">
      ...
      <div class="maamu-input-zone">
        ...
        <div class="maamu-template-row">
          <button class="maamu-template-btn" data-template-id="my-progress-summary" data-template-category="web" data-template="Look at my full AllTracker data — rank, total hours, 30-day daily history, momentum score, routine completion, and pending task debt. Give me a savage honest summary of where I actually stand right now in simple Hinglish. No sugar-coating."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Progress Summary</span></button>
          <button class="maamu-template-btn" data-template-id="my-rank-breakdown" data-template-category="web" data-template="Using my leaderboard rank and total hours from my data, tell me exactly how many hours I need this week to move up one rank tier. Compare me to the top players and roast me if I'm far behind."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Rank Breakdown</span></button>
          <button class="maamu-template-btn" data-template-id="my-focus-plan-today" data-template-category="web" data-template="From my pending tasks, current routine completion status, and my peak study hour from my session history — build me a zero-distraction execution plan for today. Tell me what to do, in what order, and for how long."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Today's Plan</span></button>
          <button class="maamu-template-btn" data-template-id="debug-code" data-template-category="coding" data-template="Debug this code. Give me the root cause first, then the exact fix. No fluff."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Debug Code</span></button>
          <button class="maamu-template-btn" data-template-id="interview-me" data-template-category="general" data-template="Take my interview now. One hard question at a time. Don't move to the next until I answer. Be brutal with feedback."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Interview Me</span></button>
          <button class="maamu-template-btn" data-template-id="weekly-plan" data-template-category="web" data-template="Using my 30-day tracker history, my pending task backlog, and my routine consistency trend — build me a realistic 7-day study plan. Include exact daily hour targets per category and flag which tasks to clear first."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Weekly Plan</span></button>
          <button class="maamu-template-btn" data-template-id="explain-simply" data-template-category="general" data-template="Explain this concept in simple steps with one real-world example. Keep it under 200 words."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Explain Simply</span></button>
          <button class="maamu-template-btn" data-template-id="my-category-load" data-template-category="web" data-template="From my 30-day tracker history, analyze each of my study categories. Which ones are overloaded, which are severely neglected, and which are on track? Give me a rebalance plan with specific daily hour targets."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Category Load</span></button>
          <button class="maamu-template-btn" data-template-id="my-weak-zones" data-template-category="web" data-template="Scan my 30-day tracker data and find my top 3 failure patterns — which day of the week I consistently slack, which category I avoid, and where my consistency breaks. Give a strict 7-day repair plan for each."><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Weak Zones</span></button>
          <button class="maamu-template-btn" data-template-id="my-routine-audit" data-template-category="web" data-template="Audit my routine list and tell me: which routines are I completing vs. skipping? What's my actual discipline score? What single habit change would have the highest impact on my consistency this week?"><span class="tpl-star-btn" title="Toggle favorite">☆</span><span>Routine Audit</span></button>
