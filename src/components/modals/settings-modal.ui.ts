            ...
            <div class="settings-group" style="margin-top: 10px;">
              ...
              <div style="display: flex; gap: 12px; align-items: center; margin-top: 12px;">
                ...
                <div class="font-select-wrapper" id="timerFontCustomWrapper">
                  <div class="font-select-trigger settings-input" id="timerFontTrigger"><span id="timerFontSelectedText">Inter (Default)</span> <span style="font-size: 0.7rem; opacity: 0.7;">▼</span></div>
              ...
              <div style="display: flex; gap: 12px; align-items: center; margin-top: 12px;">
                ...
                <select id="uiFontSelectInput" class="settings-input" style="display:none;">
                  <option value="chakra-petch">Chakra Petch (Default)</option>
                ...
                <div class="font-select-wrapper" id="uiFontCustomWrapper">
                  <div class="font-select-trigger settings-input" id="uiFontTrigger"><span id="uiFontSelectedText">Chakra Petch (Default)</span> <span style="font-size: 0.7rem; opacity: 0.7;">▼</span></div>
                  <div class="font-select-options" id="uiFontOptions">
                    <div class="font-option" data-value="chakra-petch" style="font-family: 'Chakra Petch', sans-serif;">Chakra Petch (Default)</div>
                    <div class="font-option" data-value="default" style="font-family: inherit;">System Default</div>
