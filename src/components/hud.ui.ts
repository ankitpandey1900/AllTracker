    ...
    <div id="activeTimerSection" style="display: none">
      <div class="hud-top-bar">
        <div class="hud-status" style="display: flex; align-items: center; gap: 8px;">
          <div class="pulse-purple" style="width: 8px; height: 8px; border-radius: 50%; background: #8b5cf6;"></div>
          <span style="font-size: 0.6rem; font-weight: 800; color: #8b5cf6; letter-spacing: 1px;">ACTIVE PHASE</span>
